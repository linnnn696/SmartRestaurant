...
class ProfilePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ProfilePage.ets(5:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('个人中心');
            Text.debugLine("entry/src/main/ets/pages/ProfilePage.ets(6:7)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 个人信息（占位）
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ProfilePage.ets(12:7)", "entry");
            // 个人信息（占位）
            Column.width('100%');
            // 个人信息（占位）
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('未登录');
            Text.debugLine("entry/src/main/ets/pages/ProfilePage.ets(13:9)", "entry");
            Text.fontSize(16);
