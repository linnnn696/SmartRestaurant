...
class OrderListPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/OrderListPage.ets(5:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('我的订单');
            Text.debugLine("entry/src/main/ets/pages/OrderListPage.ets(6:7)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 订单列表（占位）
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/OrderListPage.ets(12:7)", "entry");
            // 订单列表（占位）
            Column.width('100%');
            // 订单列表（占位）
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('暂无订单');
            Text.debugLine("entry/src/main/ets/pages/OrderListPage.ets(13:9)", "entry");
            Text.fontSize(16);
